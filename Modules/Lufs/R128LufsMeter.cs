    ...
    public class R128LufsMeter
    {
        ...
        public double IntegratedLoudness
        {
            get
            {
                ...
                double absoluteGatedMeanSquareSum = 0.0;
                ...
                double relativeGateGamma = -0.691 + 10.0 * Math.Log10(absoluteGatedMeanSquare) - 10.0;
                ...
                double relativeGatedMeanSquare = 0.0;
                double relativeGatedMeanSquareSum = 0.0;
                ...
                double integratedLoudness = -0.691 + 10.0 * Math.Log10(relativeGatedMeanSquare);
